    ...
    .array(
      z.object({
        ...
        dependencies: z
          ...
          .optional()
          .describe(
            "List of prerequisite task IDs or task names that this task depends on, supports two reference methods, name reference is more intuitive, it is a string array"
          ),
        notes: z
          .string()
          .optional()
  ...
  try {
    ...
    return {
      content: [
        {
          type: "text" as const,
          text: `Error occurred while processing task: ${errorMessage}`,
        },
      ],
    };
  }
